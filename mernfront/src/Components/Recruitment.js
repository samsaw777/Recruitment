      ...
      <Container>
        ...
        <form onSubmit={addToData}>
          ...
          <div className='partTwo'>
            ...
            <div className='inputPart'>
              <p>
                By clicking the submit button below, I cerity that all of the
                ...
                may be rejected and, if I am employed, my employement may be
                terminated at any time.{" "}
              </p>
              <p>
                In consideration of my employment, I agree to conform to the
                company's rules and regulations, and I agree that my employment
                and compenstation can be terminated, with or without cause, and
                with or without notice, at any time, at either my or the
                company's option.
              </p>
              <p>
                I also understand and agree that the terms and conditions of my
